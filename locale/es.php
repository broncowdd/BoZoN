<?php
	...
	$lang=array(
		...
		'Error, max filelength:' => 'Error, tamaño máximo para los ficheros:',
		'Error, forbidden file format!' => '¡ Error, formato prohibido !',
    	'Force local filename (leave empty=no change)'=>'Cambiar el nombre del fichero (vacío = nombre original)',
	    'filename (optionnal)'=>'Nombre de fichero (facultativo)',
	    ...
	    'The file doesn\'t fit'=>'El fichero no cabe'  ,
		...
		'Delete an account'=>'Borrar una cuenta' ,
		'Configure folders max size'=>'Limitar la capacidad de las carpetas de usuarios' ,
		'Click or dragover to reveal dropzone'=>'Haz click o arrastra un fichero para desubrir la zona de upload',		
		...
		'Rename this item?'=>'¿ Cambiar el nombre del fichero ?',
		...
		'View this share'=>'Ver este fichero',
