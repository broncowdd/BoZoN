...
// FRENCH
  $lang=array(
    ...
    // Share
        //Lock
        'This share is protected, please type the correct password:'=>'Ce lien est protégé, veuillez entrer le mot de passe.',
        
        //Read (m3u)
        'Next source'=>'Source suivante',
        'Random source'=>'Source aléatoire',
    
    // Login // Create an account // Change password
    ...
    'If you want to remove the password, just click on Renew button'=>'Si vous voulez supprimer le mot de passe, cliquez sur le bouton Régénérer le lien',
